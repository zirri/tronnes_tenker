...
```
/
├── index.html          # Home page — post list, filterable by category
...
├── js/
│   └── blog.js         # Minimal JS: post loading, category filtering, routing
├── posts/
...
- [CSS conventions](docs/css.md) — layering, pill styling, custom properties
